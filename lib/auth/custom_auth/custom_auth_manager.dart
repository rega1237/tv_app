...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    proyecto1608XproDigitalTVAuthUserSubject.add(
      Proyecto1608XproDigitalTVAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<Proyecto1608XproDigitalTVAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  Proyecto1608XproDigitalTVAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
...
Proyecto1608XproDigitalTVAuthUser? currentUser;
